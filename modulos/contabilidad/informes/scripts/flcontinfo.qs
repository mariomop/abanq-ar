...
class pgc2008 extends oficial {
	...
	function lanzarBalance(cursor:FLSqlCursor) {
		return this.ctx.pgc2008_lanzarBalance(cursor);
	}
	...
	switch (idCuentaEsp) {
		...
		default: {
			if ( parseFloat(nodo.attributeValue("co_partidas.iva")) == 4 ) {
				...
				this.iface.re4 += parseFloat(nodo.attributeValue("co_partidas.baseimponible")) / 100;
			...
			if ( parseFloat(nodo.attributeValue("co_partidas.iva")) == 7 ) {
				...
				this.iface.re7 +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible")) / 100;
			...
			if ( parseFloat(nodo.attributeValue("co_partidas.iva")) == 16 ) {
				...
				this.iface.re16 +=  parseFloat(nodo.attributeValue("co_partidas.baseimponible")) / 100;
...
function pgc2008_lanzarBalance(cursor:FLSqlCursor)
{
	var util:FLUtil = new FLUtil;

...
/** \C
	...
	informados con los datos correspondientes a la subcuenta de IVA.
...
/** \D Comprueba si la contrapartida corresponde a un cliente o proveedor y busca el CUIT/DNI correspondiente
\end */

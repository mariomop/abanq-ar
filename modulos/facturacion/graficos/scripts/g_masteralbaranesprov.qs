/***************************************************************************
                 g_masteralbaranesprov.qs  -  description
                             -------------------
...
function oficial_lanzar()
{
	...
	flfactgraf.iface.pub_lanzarGrafico(cursor, pI.nombreInforme, pI.orderBy, false, "albaranesprov");
}
...
function oficial_obtenerParamInforme():Array
{
	...
	paramInforme.orderBy = "albaranesprov.fecha";

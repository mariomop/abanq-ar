/***************************************************************************
                 g_masterreciboscli.qs  -  description
                             -------------------
...
function oficial_lanzar()
{
	...
	flfactgraf.iface.pub_lanzarGrafico(cursor, pI.nombreInforme, pI.orderBy, false, "reciboscli");
}
...
function oficial_obtenerParamInforme():Array
{
	...
	paramInforme.orderBy = "reciboscli.fecha";

/***************************************************************************
                 g_masterpresupuestoscli.qs  -  description
                             -------------------
    begin                : mie jul 30 2008
...
function oficial_lanzar()
{
	...
	flfactgraf.iface.pub_lanzarGrafico(cursor, pI.nombreInforme, pI.orderBy, false, "presupuestoscli");
}
...
function oficial_obtenerParamInforme():Array
{
	...
	paramInforme.nombreInforme = nombreInforme;
	paramInforme.orderBy = "presupuestoscli.fecha";

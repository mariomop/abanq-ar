/***************************************************************************
                 g_masterpedidoscli.qs  -  description
                             -------------------
...
function oficial_lanzar()
{
	...
	flfactgraf.iface.pub_lanzarGrafico(cursor, pI.nombreInforme, pI.orderBy, false, "pedidoscli");
}
...
function oficial_obtenerParamInforme():Array
{
	...
	paramInforme.orderBy = "pedidoscli.fecha";

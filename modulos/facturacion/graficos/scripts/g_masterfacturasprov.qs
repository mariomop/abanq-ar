/***************************************************************************
                 g_masterfacturasprov.qs  -  description
                             -------------------
...
function oficial_lanzar()
{
	...
	flfactgraf.iface.pub_lanzarGrafico(cursor, pI.nombreInforme, pI.orderBy, false, "facturasprov");
}
...
function oficial_obtenerParamInforme():Array
{
	...
	paramInforme.orderBy = "facturasprov.fecha";

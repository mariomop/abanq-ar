/***************************************************************************
                 g_masterpedidosprov.qs  -  description
                             -------------------
...
function oficial_lanzar()
{
	...
	flfactgraf.iface.pub_lanzarGrafico(cursor, pI.nombreInforme, pI.orderBy, false, "pedidosprov");
}
...
function oficial_obtenerParamInforme():Array
{
	...
	paramInforme.orderBy = "pedidosprov.fecha";

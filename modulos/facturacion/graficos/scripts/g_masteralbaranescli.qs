/***************************************************************************
                 g_masteralbaranescli.qs  -  description
                             -------------------
...
function oficial_lanzar()
{
	...
	flfactgraf.iface.pub_lanzarGrafico(cursor, pI.nombreInforme, pI.orderBy, false, "albaranescli");
}
...
function oficial_obtenerParamInforme():Array
{
	...
	paramInforme.orderBy = "albaranescli.fecha";

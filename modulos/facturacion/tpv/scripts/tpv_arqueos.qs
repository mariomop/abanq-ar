...
otra, etc).<br/>
La pestaña de ventas muestra todos los pagos asociados al arqueo y suma los totales de las los pagos en efectivo, en cta.cte, con tarjeta, con cheque y con vale.
El total de efectivo 'En Caja' es el importe que hay realmente en caja contando dinero en efectivo. El formulario ofrece una serie de campos asociados con las distintas monedas y billetes para facilitar el cálculo de este dato.<br/>

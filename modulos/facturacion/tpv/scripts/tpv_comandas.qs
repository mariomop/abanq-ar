...
//////////////////////////////////////////////////////////////////
//// IVA INCLUIDO ////////////////////////////////////////////////
class ivaIncluido extends numSerie {
	function ivaIncluido( context ) { numSerie( context ); } 	
	function datosLineaVenta():Boolean {
...
/////////////////////////////////////////////////////////////////
//// TIPO DE VENTA //////////////////////////////////////////////
class tipoVenta extends ivaIncluido {
	function tipoVenta( context ) { ivaIncluido ( context ); }
	function init() {
	...
	function validateForm():Boolean {
		return this.ctx.tipoVenta_validateForm();
	}
	function mostrarDocumento() {
		return this.ctx.tipoVenta_mostrarDocumento();
	}
	function mostrarLabelDocumento() {
		return this.ctx.tipoVenta_mostrarLabelDocumento();
	}
	function limpiarPresupuesto() {
		return this.ctx.tipoVenta_limpiarPresupuesto();
	}
	function limpiarPedido() {
		return this.ctx.tipoVenta_limpiarPedido();
	}
	function limpiarRemito() {
		return this.ctx.tipoVenta_limpiarRemito();
	}
	function limpiarFactura() {
		return this.ctx.tipoVenta_limpiarFactura();
	}
}
//// TIPO DE VENTA  /////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
//// NUMERO SECUENCIA ////////////////////////////////////////////
class numeroSecuencia extends tipoVenta {
	function numeroSecuencia( context ) { tipoVenta ( context ); } 
	function init() {
		this.ctx.numeroSecuencia_init();
	}
	function calculateField(fN:String):String {
...
//////////////////////////////////////////////////////////////////
//// HABILITACIONES //////////////////////////////////////////////
class habilitaciones extends numeroSecuencia {
	function habilitaciones( context ) { numeroSecuencia ( context ); } 
	function verificarHabilitaciones() {
		return this.ctx.habilitaciones_verificarHabilitaciones();
	}
	function bufferChanged(fN:String) {
		return this.ctx.habilitaciones_bufferChanged(fN);
	}
	function validateForm():Boolean {
		return this.ctx.habilitaciones_validateForm();
	}
}
//// HABILITACIONES //////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
//// MODO ACCESO /////////////////////////////////////////////////
class modoAccesso extends habilitaciones {
	var modoAcceso:Number;
	function modoAccesso( context ) { habilitaciones ( context ); } 
	function init() {
...
/////////////////////////////////////////////////////////////////
//// TOTALES CON IVA ////////////////////////////////////////////
class totalesIva extends modoAccesso {
    function totalesIva( context ) { modoAccesso ( context ); }
	function sumarUno(idLinea:Number):Boolean{
		return this.ctx.totalesIva_sumarUno(idLinea);
	}
	function restarUno(idLinea:Number):Boolean{
		return this.ctx.totalesIva_restarUno(idLinea);
	}
	function descontar(idLinea:Number, descuentoLineal:Number, porDescuento:Number):Boolean {
		return this.ctx.totalesIva_descontar(idLinea, descuentoLineal, porDescuento);
	}
	function calcularTotalesLinea(fN:String, cursor:FLSqlCursor):Number {
		return this.ctx.totalesIva_calcularTotalesLinea(fN, cursor);
	}
	function aplicarTarifaLinea(codTarifa:String):Boolean {
		return this.ctx.totalesIva_aplicarTarifaLinea(codTarifa);
	}
	function datosLineaVenta():Boolean {
		return this.ctx.totalesIva_datosLineaVenta();
	}
}
//// TOTALES CON IVA ////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
//// CANT LINEAS /////////////////////////////////////////////////
class cantLineas extends totalesIva {
	function cantLineas( context ) { totalesIva( context ); } 
	function validateForm():Boolean {
...
{
	var cursor:FLSqlCursor = this.cursor();
	var idFactura:String = cursor.valueBuffer("iddocumento");
...
function tipoVenta_init()
{
	...
	connect(this.child("toolButtonZoomDocumento"), "clicked()", this, "iface.mostrarDocumento()");
	connect(this.child("tbwComanda"),"currentChanged(QString)", this, "iface.mostrarLabelDocumento()");

	this.iface.mostrarLabelDocumento();
	...
	switch (fN) {
		case "codserie": {
			switch (cursor.valueBuffer("tipoventa")) {
				case "Factura": {
					if (cursor.valueBuffer("claseventa") == "A")
						valor = util.sqlSelect("tpv_puntosventa", "codserie_a", "codtpv_puntoventa = '" + cursor.valueBuffer("codtpv_puntoventa") + "'");
					else if (cursor.valueBuffer("claseventa") == "B")
						valor = util.sqlSelect("tpv_puntosventa", "codserie_b", "codtpv_puntoventa = '" + cursor.valueBuffer("codtpv_puntoventa") + "'");
					else if (cursor.valueBuffer("claseventa") == "C")
						valor = util.sqlSelect("tpv_puntosventa", "codserie_c", "codtpv_puntoventa = '" + cursor.valueBuffer("codtpv_puntoventa") + "'");
					else
						valor = util.sqlSelect("tpv_puntosventa", "codserie_b", "codtpv_puntoventa = '" + cursor.valueBuffer("codtpv_puntoventa") + "'");
					break;
				}
				case "Ticket": {
					valor = util.sqlSelect("tpv_puntosventa", "codserie_ticket", "codtpv_puntoventa = '" + cursor.valueBuffer("codtpv_puntoventa") + "'");
					break;
				}
				case "Remito": {
					valor = util.sqlSelect("tpv_puntosventa", "codserie_remito", "codtpv_puntoventa = '" + cursor.valueBuffer("codtpv_puntoventa") + "'");
					break;
				}
				case "Pedido": {
					valor = util.sqlSelect("tpv_puntosventa", "codserie_pedido", "codtpv_puntoventa = '" + cursor.valueBuffer("codtpv_puntoventa") + "'");
					break;
				}
				case "Presupuesto": {
					valor = util.sqlSelect("tpv_puntosventa", "codserie_presupuesto", "codtpv_puntoventa = '" + cursor.valueBuffer("codtpv_puntoventa") + "'");
					break;
				}
			}
			if (!valor || valor == "") {
				MessageBox.warning("No hay una serie definida para el comprobante '" + cursor.valueBuffer("tipoventa") + " " + cursor.valueBuffer("claseventa") + "' en este punto de venta\nPor favor, configure la serie correspondiente.", MessageBox.Ok, MessageBox.NoButton,MessageBox.NoButton);
		...
		case "claseventa": {
			valor = " ";
			if ( cursor.valueBuffer("tipoventa") == "Factura" )
				valor = flfacturac.iface.pub_tipoComprobanteRegimenIvaCliente( cursor.valueBuffer("codcliente") );
			break;
		}
		case "estado": {
			valor = this.iface.__calculateField(fN);
...
function tipoVenta_bufferChanged(fN:String)
{
	...
	switch (fN) {
		case "tipopago":{
			if (cursor.valueBuffer("tipopago") == "Efectivo") {
			...
			else if (cursor.valueBuffer("tipopago") == "Cta.Cte.") {
				var pagoCtaCte:String = util.sqlSelect("tpv_datosgenerales", "pagoctacte", "1=1");
				if(!pagoCtaCte || pagoCtaCte == "")
					MessageBox.information(util.translate("scripts", "No tiene configurada la forma de pago en cuenta corriente en el formulario de datos generales"),MessageBox.Ok, MessageBox.NoButton);
				cursor.setValueBuffer("codpago", pagoCtaCte);
			}
				...
				var pagoCheque:String = util.sqlSelect("tpv_datosgenerales", "pagocheque", "1=1");
				if(!pagoCheque || pagoCheque == "")
					MessageBox.information(util.translate("scripts", "No tiene configurada la forma de pago cheque en el formulario de datos generales"),MessageBox.Ok, MessageBox.NoButton);
				cursor.setValueBuffer("codpago", pagoCheque);
			}
			else {
		...
		case "tipoventa": {
			...
			// Chequear al cambiar de tipo venta si no quedó creado otro documento vacío
			switch (cursor.valueBuffer("tipoventa")) {
				case "Presupuesto": {
					this.iface.limpiarPedido();
					this.iface.limpiarRemito();
					this.iface.limpiarFactura();
					break;
				}
				case "Pedido": {
					this.iface.limpiarPresupuesto();
					this.iface.limpiarRemito();
					this.iface.limpiarFactura();
					break;
				}
		...
		case "refarticulo": {
			cursor.setValueBuffer("referencia", cursor.valueBuffer("refarticulo"));
			cursor.setNull("refarticulo");
			break;
		}
		default:
			this.iface.__bufferChanged(fN);
...
function tipoVenta_validateForm()
{
	var util:FLUtil = new FLUtil();
	var cursor:FLSqlCursor = this.cursor();

	if ( cursor.valueBuffer("tipoventa") == "Presupuesto" && parseFloat(cursor.valueBuffer("pagado")) > 0) {
		MessageBox.warning(util.translate("scripts", "Los presupuestos no pueden registrar pagos"), MessageBox.Ok, MessageBox.NoButton);
		return false;
	}

	if ( cursor.valueBuffer("tipoventa") == "Pedido" && parseFloat(cursor.valueBuffer("pagado")) > 0) {
		MessageBox.warning(util.translate("scripts", "Los pedidos no pueden registrar pagos"), MessageBox.Ok, MessageBox.NoButton);
		return false;
	}

	if ( cursor.valueBuffer("tipoventa") == "Remito" && parseFloat(cursor.valueBuffer("pagado")) > 0) {
		MessageBox.warning(util.translate("scripts", "Los remitos no pueden registrar pagos"), MessageBox.Ok, MessageBox.NoButton);
		return false;
	}
...
/** \D Muestra el documento asociado a la venta
\end */
function tipoVenta_mostrarDocumento()
{
	var cursor:FLSqlCursor = this.cursor();
	...
	switch (cursor.valueBuffer("tipoventa")) {
		case "Presupuesto": {
			curDocumento = new FLSqlCursor("presupuestoscli");
			curDocumento.select("idpresupuesto = " + idDocumento);
			if (!curDocumento.first())
				return;
			break;
		}
		case "Pedido": {
			curDocumento = new FLSqlCursor("pedidoscli");
			curDocumento.select("idpedido = " + idDocumento);
			if (!curDocumento.first())
				return;
			break;
		}
...
function tipoVenta_mostrarLabelDocumento()
{
	var cursor:FLSqlCursor = this.cursor();
	var util:FLUtil = new FLUtil();
	var idDocumento:String = cursor.valueBuffer("iddocumento");
	...
	switch (cursor.valueBuffer("tipoventa")) {
		case "Presupuesto": {
			codigo = util.sqlSelect("presupuestoscli", "codigo", "idpresupuesto = " + idDocumento);
			if (!codigo)
				codigo = "";
		...
		case "Pedido": {
			codigo = util.sqlSelect("pedidoscli", "codigo", "idpedido = " + idDocumento);
			if (!codigo)
				codigo = "";
			label = "Pedido " + codigo;
			break;
		...
		case "Remito": {
			codigo = util.sqlSelect("albaranescli", "codigo", "idalbaran = " + idDocumento);
			if (!codigo)
				codigo = "";
			label = "Remito " + codigo;
			break;
		...
		default: {
			codigo = util.sqlSelect("facturascli", "codigo", "idfactura = " + idDocumento);
			if (!codigo)
				codigo = "";
	...
	this.child("lblCodigo").setText(label);
}

function tipoVenta_limpiarPresupuesto()
{
	var cursor:FLSqlCursor = this.cursor();

	var curDoc:FLSqlCursor = new FLSqlCursor("presupuestoscli");
	curDoc.select("idpresupuesto = " + cursor.valueBuffer("iddocumento") + " AND idtpv_comanda = " + cursor.valueBuffer("idtpv_comanda"));
	if (curDoc.first()) {
		curDoc.setModeAccess(curDoc.Del);
		curDoc.refreshBuffer();
		curDoc.commitBuffer();
	}
}

function tipoVenta_limpiarPedido()
{
	var cursor:FLSqlCursor = this.cursor();

	var curDoc:FLSqlCursor = new FLSqlCursor("pedidoscli");
	curDoc.select("idpedido = " + cursor.valueBuffer("iddocumento") + " AND idtpv_comanda = " + cursor.valueBuffer("idtpv_comanda"));
	if (curDoc.first()) {
		curDoc.setModeAccess(curDoc.Del);
		curDoc.refreshBuffer();
		curDoc.commitBuffer();
...
function tipoVenta_limpiarRemito()
{
	var cursor:FLSqlCursor = this.cursor();

	var curDoc:FLSqlCursor = new FLSqlCursor("albaranescli");
	curDoc.select("idalbaran = " + cursor.valueBuffer("iddocumento") + " AND idtpv_comanda = " + cursor.valueBuffer("idtpv_comanda"));
	if (curDoc.first()) {
		curDoc.setModeAccess(curDoc.Del);
		curDoc.refreshBuffer();
		curDoc.commitBuffer();
...
function tipoVenta_limpiarFactura()
{
	var cursor:FLSqlCursor = this.cursor();

	var curDoc:FLSqlCursor = new FLSqlCursor("facturascli");
	curDoc.select("idfactura = " + cursor.valueBuffer("iddocumento") + " AND idtpv_comanda = " + cursor.valueBuffer("idtpv_comanda"));
	if (curDoc.first()) {
		curDoc.setModeAccess(curDoc.Del);
		curDoc.refreshBuffer();
		curDoc.commitBuffer();
...
function numeroSecuencia_calculateField(fN:String):String
{
	...
	switch (fN) {
		case "numerosecuencia": {
			var idSec:Number = util.sqlSelect("secuenciasejercicios", "id", "codejercicio = '" + flfactppal.iface.pub_ejercicioActual() + "' AND codserie = '" + cursor.valueBuffer("codserie") + "'");
			if (!idSec) {
				valor = 0;
				break;
			}
			...
			var numero:Number = util.sqlSelect("secuencias", "valorout", "id = " + idSec + " AND nombre = '" + nombre + "'");
...
{
	var cursor:FLSqlCursor = this.cursor();
	// al aceptar se incrementa el número de secuencia
	if ( this.iface.modoAcceso == cursor.Insert ) {
		var cursorSecuencias:FLSqlCursor = new FLSqlCursor("secuenciasejercicios");
		cursorSecuencias.setActivatedCheckIntegrity(false);
		cursorSecuencias.select("upper(codserie) = '" + cursor.valueBuffer("codserie") + "' AND upper(codejercicio) = '" + flfactppal.iface.pub_ejercicioActual() + "'");
		if (cursorSecuencias.next()) {
			...
			cursorSecs.select( "id = " + idSec + " AND nombre = '" + nombre + "'" );
			if (cursorSecs.next()) {
				...
				cursorSecs.setValueBuffer( "nombre", nombre );
...
function numeroSecuencia_bufferChanged(fN:String)
{
	switch (fN) {
		case "codserie": {
			this.child("fdbNumeroSecuencia").setValue(this.iface.calculateField("numerosecuencia"));
			break;
		}
		default:
			this.iface.__bufferChanged(fN);
...
function habilitaciones_verificarHabilitaciones()
{
	...
	if (cursor.valueBuffer("editable")) {
		...
		if ( this.iface.modoAcceso == this.cursor().Insert ) {
			...
			this.child("fdbNumeroSecuencia").setDisabled(false);
		} else {
			this.child("fdbTipoVenta").setDisabled(true);
			this.child("fdbNumeroSecuencia").setDisabled(true);
		}
...
// 					desbloquea aquí todo
					...
					this.child("gbxCliente").setEnabled(true);
					this.child("tdbLineasComanda").setReadOnly(false);
					...
					if (parseFloat(this.child("fdbTotalComanda").value()) == 0) {
						...
						this.child("tdbPagos").setReadOnly(false);
						this.child("tdbVales").setReadOnly(false);
					}

					var total:Number = parseFloat(cursor.valueBuffer("total"))
					if (total > 0 && total == parseFloat(cursor.valueBuffer("pagado"))) {
						this.child("fdbTipoPago").setDisabled(true);
					} else {
				...
				if ( this.cursor().isNull("iddocumento") )
					...
					this.child("tbwDocumento").setTabEnabled("recibos", true);
...
function habilitaciones_bufferChanged(fN:String)
{
	switch (fN) {
		case "total":
		case "pagado": {
...
function habilitaciones_validateForm():Boolean
{
	...
	if ( cursor.valueBuffer("tipoventa") != "Presupuesto" && cursor.valueBuffer("tipoventa") != "Pedido" && cursor.valueBuffer("tipoventa") != "Remito" &&
	    parseFloat(cursor.valueBuffer("total")) != parseFloat(cursor.valueBuffer("pagado")) ) {
	...
	if ( parseFloat(cursor.valueBuffer("total")) == parseFloat(cursor.valueBuffer("pagado"))) {
		...
		if ( util.sqlSelect("tpv_datosgenerales", "integracionfac", "1 = 1") )
...
{
	// se toma nota del modo de acceso y del estado inicial de la comanda (abierta o cerrada)
...
function totalesIva_sumarUno(idLinea:Number):Boolean
{
	if (!idLinea)
		return false;
	...
	curLinea.setValueBuffer("totalconiva",this.iface.calcularTotalesLinea("totalconiva",curLinea));
...
function totalesIva_restarUno(idLinea:Number):Boolean
{
	if(!idLinea)
		return false;
...
function totalesIva_descontar(idLinea:Number,descuentoLineal:Number,porDescuento:Number):Boolean
{
	if (!idLinea)
		return false;
	var util:FLUtil = new FLUtil;
	...
	curLinea.setValueBuffer("totalconiva", formRecordtpv_lineascomanda.iface.pub_commonCalculateField("totalconiva",curLinea));
	if (!curLinea.commitBuffer())
		return false;
...
function totalesIva_calcularTotalesLinea(fN:String, cursor:FLSqlCursor):Number
{
	var util:FLUtil = new FLUtil();
	var valor:Number;
	...
	switch (fN) {
		...
		default:
			valor = this.iface.__calcularTotalesLinea(fN, cursor);
			break;
	}
	return valor;
}

function totalesIva_aplicarTarifaLinea(codTarifa:String):Boolean
{
	if (!this.iface.__aplicarTarifaLinea(codTarifa))
		return false;

	this.iface.curLineas.setValueBuffer("totalconiva",
	formRecordtpv_lineascomanda.iface.pub_commonCalculateField("totalconiva", this.iface.curLineas));

	return true;
}

function totalesIva_datosLineaVenta():Boolean
{
...
function cantLineas_validateForm()
{
	...
	var hayLineas:FLSqlCursor = this.child("tdbLineasComanda").cursor();
	hayLineas.select("idtpv_comanda = " + this.cursor().valueBuffer("idtpv_comanda"));
	if (hayLineas.size() < 1) {
		return false;
	}

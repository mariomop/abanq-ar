/**************************************************************************
                 tpv_agruparalbaranescli.qs  -  description
                             -------------------
    begin                : vie ago 07 2009
...
class oficial extends interna {
	...
	function calcularTotalFactura() {
		return this.ctx.oficial_calcularTotalFactura();
	}
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function oficial_incluirFila(fila:Number, col:Number)
{
	...
	this.iface.calcularTotalFactura();
}
...
function oficial_actualizar()
{
	...
	var where:String = formtpv_comandas.iface.pub_whereAgrupacion(this.cursor());
	where += " ORDER BY codcliente,codtpv_puntoventa DESC";
...
function oficial_insertarLineaTabla(curAlbaranes:FLSqlCursor)
{
	...
	this.iface.tblAlbaranes.setText(numLinea, this.iface.COL_IDALBARAN, curAlbaranes.valueBuffer("idtpv_comanda"));
}
...
function oficial_calcularTotalFactura()
{
	var util:FLUtil = new FLUtil;
	var total:Number = 0;
	...
	for (fila = 0; fila < this.iface.tblAlbaranes.numRows(); fila++) {
		if (this.iface.tblAlbaranes.text(fila, this.iface.COL_INCLUIR) == "Sí")
			total += parseFloat(this.iface.tblAlbaranes.text(fila, this.iface.COL_TOTAL));
	}

	total = util.roundFieldValue(total, "facturascli", "total");

	this.child("lblTotalFactura").setText(total);
}
//// OFICIAL /////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////

...
function interna_validateForm():Boolean
{
	...
	*/
	...
	if ((totalComanda - totalPagos) < parseFloat(cursor.valueBuffer("importe"))) {
		MessageBox.warning(util.translate("scripts", "El importe del pago hace que la suma de pagos sea superior al importe de la venta"), MessageBox.Ok, MessageBox.NoButton);
		return false;
	}

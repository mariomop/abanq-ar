...
/////////////////////////////////////////////////////////////////
//// SILIXORDENCAMPOS ///////////////////////////////////////////
class silixOrdenCampos extends multiFamilia {
    function silixOrdenCampos( context ) { multiFamilia ( context ); }
	function init() {
		this.ctx.silixOrdenCampos_init();
	}
	function ordenarColumnas() {
		this.ctx.silixOrdenCampos_ordenarColumnas();
	}
}
//// SILIXORDENCAMPOS ///////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
function silixOrdenCampos_init()
{
	...
	connect(this.child("tbwArticulos"), "currentChanged(QString)", this, "iface.ordenarColumnas()");
}

function silixOrdenCampos_ordenarColumnas()
{
	var orden:Array = [ "descripcionextendida", "codfamilia", "codunidad", "marcacion", "codgrupoatr", "publico", "orden" ];

	this.child("tdbFamiliasHijas").setOrderCols(orden);
}

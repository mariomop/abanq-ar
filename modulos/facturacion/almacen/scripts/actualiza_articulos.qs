/***************************************************************************
                 actualiza_articulos.qs  -  description
                             -------------------
...
/** @class_declaration actArticulos */
//////////////////////////////////////////////////////////////////
//// ACT_ARTICULOS ///////////////////////////////////////////////
class actArticulos extends oficial 
{
	var CR:Number;
	var sep:String = ";";
    ...
    function actArticulos( context ) { oficial ( context ); }
	function init() {
		return this.ctx.actArticulos_init();
	}
	function importar() {
		return this.ctx.actArticulos_importar();
	}
	function preprocesarFichero(tabla:String, file, posClaveFich:String, encabezados:String):Array {
		return this.ctx.actArticulos_preprocesarFichero(tabla, file, posClaveFich, encabezados);
	}
	function leerLinea(file, numCampos):String {
		return this.ctx.actArticulos_leerLinea(file, numCampos);
	}
	function crearCorrespondencias() {
		return this.ctx.actArticulos_crearCorrespondencias();
	}
	function crearPosiciones(cabeceras:String) {
		return this.ctx.actArticulos_crearPosiciones(cabeceras);
	}
	function comprobarFichero(cabeceras:String) {
		return this.ctx.actArticulos_comprobarFichero(cabeceras);
	}
	function whereTablaDestino( linea:String ):String {
		return this.ctx.actArticulos_whereTablaDestino( linea );
	}
	function comprobarCampoDefecto(nomCampo:String):Boolean {
		return this.ctx.actArticulos_comprobarCampoDefecto(nomCampo);
	}
}
//// ACT_ARTICULOS ///////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////
//// DESARROLLO //////////////////////////////////////////////////
class head extends actArticulos {
    function head( context ) { actArticulos ( context ); }
}
//// DESARROLLO //////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
/** @class_definition actArticulos */
//////////////////////////////////////////////////////////////////
//// ACT_ARTICULOS ///////////////////////////////////////////////

function actArticulos_init()
{
...
function actArticulos_importar()
{
	var util:FLUtil = new FLUtil();
...
\end */
function actArticulos_whereTablaDestino( linea:String ):String {
...
*/
function actArticulos_preprocesarFichero(tabla:String, file, posClaveFich:String, encabezados:String):Array 
{
...
function actArticulos_leerLinea(file, numCampos):String
{
...
function actArticulos_crearCorrespondencias()
{
...
*/
function actArticulos_crearPosiciones(cabeceras:String)
{
	// Eliminar el retorno de carro
...
@param cabeceras String con la primera línea del fichero que contiene las cabeceras
*/
function actArticulos_comprobarFichero(cabeceras:String)
{
	var util:FLUtil = new FLUtil();
...
function actArticulos_comprobarCampoDefecto(nomCampo:String):Boolean
{

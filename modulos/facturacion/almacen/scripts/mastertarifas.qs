...
class preciosTarifa extends infoTarifa {
	...
	function actualizarPreciosTarifa(codTarifa:String):Boolean {
		return this.ctx.preciosTarifa_actualizarPreciosTarifa(codTarifa);
	}
}
//// PRECIOS TARIFA /////////////////////////////////////////////
/////////////////////////////////////////////////////////////////
...
function preciosTarifa_actualizarPreciosTarifa(codTarifa:String):Boolean
{
	...
	util.destroyProgressDialog();
	MessageBox.information(util.translate("scripts", "Se completó la actualización"), MessageBox.Ok, MessageBox.NoButton);
	return true;
}

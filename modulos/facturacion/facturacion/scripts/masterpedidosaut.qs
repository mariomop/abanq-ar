...
{
	return; // No existe aún el informe de pedidos automáticos.
...
/** \C
Al pulsar el botón de generar pedido se creará el remito correspondiente al pedido automatico seleccionado.
\end */
...
function fechas_init()
{
	...
	var mostrarDias:Number = flfactppal.iface.pub_valorDefectoEmpresa("filtropedidosauto");

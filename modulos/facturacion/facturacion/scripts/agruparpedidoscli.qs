...
//// INTERNA /////////////////////////////////////////////////////
/** \C
Este formulario agrupa distintos pedidos del mismo cliente un único remito. Es posible especificar los criterios que deben cumplir los pedidos a incluir. De la lista de pedidos que cumplen los criterios de búsqueda se generará un remito por cliente (ej. si los pedidos corresponden a dos clientes se generarán dos remitos).
\end */
function interna_init()
{
		...
		this.child("fdbCodSerie").setValue(flfactppal.iface.pub_valorDefectoEmpresa("codserie_pedido"));
...
/** \D
Actualiza la lista de remitos en función de los criterios de búsqueda especificados
\end */
...
/** \D
Elabora un string en el que figuran, separados por comas, los identificadores de aquellos pedidos que el usuario haya marcado como 'No' (no incluir en la remito). Este string se usará para ser incluido en una sentencia NOT IN en el select de los pedidos.

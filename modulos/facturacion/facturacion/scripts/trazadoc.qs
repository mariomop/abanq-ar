...
function interna_init()
{
	...
	this.iface.tblDocs.setColumnLabels("/", "Presupuestos/Pedidos/Remitos/Facturas/Comprobantes/Pagos/");
...
function funServiciosCli_init()
{
	...
	this.iface.tblDocs.hideColumn(6);
	this.iface.tblDocs.setColumnLabels("/", "Presupuestos/Pedidos/Remitos/Facturas/Comprobantes/Pagos/Servicios/Servicios");

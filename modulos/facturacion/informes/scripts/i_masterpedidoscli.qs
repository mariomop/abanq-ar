...
function csv_init()
{
	...
	if (this.cursor().action() == "i_respedidoscli")
...
function csv_lanzarCSV()
{
	...
	flfactinfo.iface.pub_lanzarInformeCSV(cursor, pI.nombreInforme, pI.orderBy, pI.groupBy, pI.whereFijo, pI.nombreInforme, cabecera, indices);
}

/***************************************************************************
                 i_masterpagosmultiprov.qs  -  description
                             -------------------
...
function oficial_obtenerOrden(nivel:Number, cursor:FLSqlCursor):String
{
	...
	switch(nivel) {
		...
		case 2: {
			switch(orden) {
				case "Código": {
					ret += "pagosmultiprov.codigo";
					break;
				}
				case "Cod.Cliente": {
					ret += "pagosmultiprov.codproveedor";
					break;
				}
				case "Proveedor": {
					ret += "pagosmultiprov.nombreproveedor";
					break;
				}
				case "Fecha": {
					ret += "pagosmultiprov.fecha";
					break;
				}
				case "Total": {
					ret += "pagosmultiprov.total";
					break;
				}
			}
			break;

/***************************************************************************
                 i_mastersalidasarticulos.qs  -  description
                             -------------------
...
function oficial_obtenerParamInforme():Array
{
	...
	paramInforme.orderBy = "lineassalidasarticulos.referencia";
	var o:String = "";
	for (var i:Number = 1; i < 2; i++) {
		o = this.iface.obtenerOrden(i, cursor, "lineassalidasarticulos");
		if (o) {
	...
	if (cursor.valueBuffer("codintervalo")) {
		...
		cursor.setValueBuffer("d_lineassalidasarticulos_fecha", intervalo.desde);
		cursor.setValueBuffer("h_lineassalidasarticulos_fecha", intervalo.hasta);
	}

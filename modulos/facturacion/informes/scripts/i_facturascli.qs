...
function oficial_bufferChanged(fN:String)
{
	...
	switch(fN){
		...
		case "rectificada":{
			if (cursor.valueBuffer("rectificada") == true) {
				cursor.setValueBuffer("decredito", false);
				cursor.setValueBuffer("dedebito", false);
			}
			break;
		}
		case "decredito":{
			if (cursor.valueBuffer("decredito") == true) {
				cursor.setValueBuffer("rectificada", false);
				cursor.setValueBuffer("dedebito", false);
			}
			break;
		}
		case "dedebito":{
			if (cursor.valueBuffer("dedebito") == true) {
				cursor.setValueBuffer("rectificada", false);
				cursor.setValueBuffer("decredito", false);
			}
			break;

...
/*	var swift:String = cursor.valueBuffer("swift");
	...
	var cbu:String = cursor.valueBuffer("cbu");
	if ( cbu && cbu != "" && cbu.length != 22 ){
		MessageBox.warning(util.translate("script", "El CBU debe ser exactamente de 22 dígitos"), MessageBox.Ok, MessageBox.NoButton);
		return false;
	}
...
function oficial_datosSucursal() {
	...
	qryAgencia.setSelect("nombre, direccion");
	...
	if (qryAgencia.first()) {
		...
		this.child("ledDireccion").text = qryAgencia.value("direccion");
	}
	else {
		this.child("ledSucursal").text = "";
		this.child("ledDireccion").text = "";
	}
}
//// OFICIAL /////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////

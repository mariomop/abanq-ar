...
/////////////////////////////////////////////////////////////////
//// PUB_SILIXSELECCION /////////////////////////////////////////
class pubSilixSeleccion extends pubTraducciones {
	function pubSilixSeleccion( context ) { pubTraducciones( context ); }
...
function oficial_valoresIniciales()
{
	...
	with(cursor) {
		...
		setModeAccess(cursor.Insert);
		refreshBuffer();
		setValueBuffer("codpago", "R.SELLADOS");
		setValueBuffer("descripcion", "RETENCION SELLADOS");
		setValueBuffer("genrecibos", "Pagados");
		commitBuffer();
		setModeAccess(cursor.Insert);
		refreshBuffer();
		setValueBuffer("codpago", "R.MUNICIP");
		setValueBuffer("descripcion", "RETENCION MUNICIPAL");
		setValueBuffer("genrecibos", "Pagados");
		commitBuffer();
		setModeAccess(cursor.Insert);
		refreshBuffer();
		setValueBuffer("codpago", "RET.IVA");
		setValueBuffer("descripcion", "RETENCION I.V.A.");
		setValueBuffer("genrecibos", "Pagados");
		commitBuffer();
		setModeAccess(cursor.Insert);
		refreshBuffer();
		setValueBuffer("codpago", "RET.DGR");
		setValueBuffer("descripcion", "RETENCION D.G.R.");
		setValueBuffer("genrecibos", "Pagados");
		commitBuffer();
		setModeAccess(cursor.Insert);
		refreshBuffer();
		setValueBuffer("codpago", "R.EMPLEAD");
		setValueBuffer("descripcion", "RETENCION EMPLEADORES");
		setValueBuffer("genrecibos", "Pagados");
		commitBuffer();
	}
	delete cursor;

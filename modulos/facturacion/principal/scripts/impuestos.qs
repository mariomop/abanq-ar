...
\end */
	if (!sys.isLoadedModule("flcontppal"))
		this.child("tbwImpuestos").setTabEnabled("contabilidad", false);
	else {
...
function oficial_tbnAyuda_clicked()
{
	...
	"Para el correcto funcionamiento de la generación automática de asientos de facturas y de los informes contables \n" +
	"es necesario asociar a cada tipo de I.V.A. sus subcuentas correspondientes.\n\n" + 
	...
	"exentos la subcuenta 4720000999 podemos asociar este valor de subcuenta a todos los registros de I.V.A. (GRAVADO, REDUCIDO, EXENTO, etc). De lo que sí \n" +

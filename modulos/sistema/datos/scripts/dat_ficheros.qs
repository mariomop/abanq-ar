...
class oficial extends interna {
	...
	function dbf2csv() { return this.ctx.oficial_dbf2csv(); } 
	function numeroLineas( fichero ):Number { return this.ctx.oficial_numeroLineas( fichero ); } 
	function leerLineas( fichero, desde, hasta ):Array { return this.ctx.oficial_leerLineas( fichero, desde, hasta ); } 
	function actualizarMuestra() { return this.ctx.oficial_actualizarMuestra(); } 
	function actualizarCampos() { return this.ctx.oficial_actualizarCampos(); } 
...
class ifaceCtx extends head {
	...
	function pub_leerLineas( fichero, desde, hasta ):Array { return this.leerLineas( fichero, desde, hasta ); } 
	function pub_numeroLineas( fichero ):Number { return this.numeroLineas( fichero ); } 
}

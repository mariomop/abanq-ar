...
class oficial extends interna {
	...
	function agregarCorrespondencia() { return this.ctx.oficial_agregarCorrespondencia(); }
	function quitarCorrespondencia() { return this.ctx.oficial_quitarCorrespondencia(); }
	function enCorrespondencia( campo, valorCampo ):Boolean { return this.ctx.oficial_enCorrespondencia( campo, valorCampo ); }
	function actualizarCamposFichero() { return this.ctx.oficial_actualizarCamposFichero(); }
	function actualizarCamposTabla() { return this.ctx.oficial_actualizarCamposTabla(); }
	function actualizarControles() { return this.ctx.oficial_actualizarControles(); }
	function actualizarMuestra() { return this.ctx.oficial_actualizarMuestra(); }
	function borrarFuncion() { return this.ctx.oficial_borrarFuncion(); }
	function borrarValorFijo() { return this.ctx.oficial_borrarValorFijo(); }
	function bufferChanged( fN ) { return this.ctx.oficial_bufferChanged(); }
}
//// OFICIAL /////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////
...
function oficial_actualizarControles() 
{
	...
	debug(this.child( "tdbCor" ).currentRow());
	...
	for ( i = 0; i < lineas.length; i++ ) {
		...
		for ( j = 0; j < numCampos; j++ ) {
			if ( posiciones[ j ] < linea.length ) {
				valor = fldatosppal.iface.pub_datoCampo( tipos[ j ], camposFichero[ j ],
